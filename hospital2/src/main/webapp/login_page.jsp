...
<body>
    <div style="padding-top: 150px;padding-left: 550px;" class="col-md-6 login-form-1">
    	<h1 style="width: 500px; padding-left: 138px;">Login</h1> 
    		<form style="padding-top: 20px;"  method="POST" action="sign_in">
            	...
            	<div class="form-group">
                    <input style="width: 400px;" type="submit" class="btnSubmit" value="login" />
                </div>
            </form>
     </div>
</body>
